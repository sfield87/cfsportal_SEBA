...
,case 
    ...
    when bid.type_code = 7 then (cdb.trans_dt + (1/24))
                    ...
                    from appl_archive.a_bill_invoice_detail bid2 
...
,case 
    ...
    when bid.type_code = 7 then ((ADD_MONTHS(cdb.trans_dt,1) - 1)+ (1/24)) 
                   ...
                   from appl_archive.a_bill_invoice_detail bid3 
...
FROM cmf c,    
    ...
    appl_archive.a_bill_invoice_detail bid,
    appl_archive.a_cdr_billed cdb,    
