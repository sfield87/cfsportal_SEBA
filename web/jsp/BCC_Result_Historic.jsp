...
<div id="wrapper" class="toggled toggled-2 full-height">
            ...
            <div class="container-fluid">
                    ...
                    <table id="mydatatable" data-search="true" class="table table-striped table-hover">
                        ...
                        <%
                            ...
                            try {
                                ...
                                BufferedReader reader = new BufferedReader(new FileReader("\\\\latamfs\\Latam CFS Applications\\Web Server Files\\Resources\\Query\\Web_Queries\\BCC_Result_query0_hist.sql"));
                        ...
                        <tr>
                            ...
                            <td contenteditable="true"><%=Credit%>
                            </td>
                            <td contenteditable="true"><%=rs.getString(3)%>
                            </td>
                            <td><%=rs.getString(4)%>
                            </td>
                            <td contenteditable="true"><%=rs.getString(5)%>
                            </td>
                            <td contenteditable="true"><%=rs.getString(6)%>
                            </td>
                            <td contenteditable="true"><%=rs.getString(7)%>
                            </td>
                            <td contenteditable="true"><%=rs.getString(8)%>
                            </td>
                            <td contenteditable="true"><%=rs.getString(9)%>
                            </td>
                ...
                <div class="row text-right">
                    <p id="xportxlsx" class="xport">
                        <button class="btn btn-go" type="submit" onclick="doit('xlsx');"
                                style="border: 2px solid #48D597">Download
    ...
    <script type="text/javascript">
        $("h4").text("Historic Invoices Detail by Charge");
    ...
    <script>
        function export_table_to_excel(id, type, fn) {
            ...
            var fname = fn || 'BCC_Detail_Historic.' + type;
            try {
