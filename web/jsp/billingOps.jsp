          ...
          // sta = cnx.createStatement();  //inicializo conex
           ...
           while(rs.next()){
            ...
            <tr>
                ...
                <select class="btn btn-success btn-xs dropdown-toggle" type="button" data-toggle="dropdown" onchange="populateSelect(this.value)">
                        <option value = "ST"><%=rs.getString(6)%></option>
                ...
                <td style="text-align: left; vertical-align: middle;">
                <select class="btn btn-success btn-xs dropdown-toggle" type="button" data-toggle="dropdown" onchange="populateSelect(this.value)">
                        <option value = "ST"><%=rs.getString(7)%></option>
                ...
                <td style="text-align: left; vertical-align: middle;">
                <select class="btn btn-success btn-xs dropdown-toggle" type="button" data-toggle="dropdown" onchange="populateSelect(this.value)">
                        <option value = "ST"><%=rs.getString(8)%></option>
                ...
                <td contenteditable="true"><%=rs.getString(14)%> </td>
...
if(accion.equals("consulta")){
  ...
  "WHERE [SUBCASE_ID] =  ? "; 
           ...
           ps.setString(1, String.valueOf(tktSearch) +" ");
