    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
            ...
            <li>
                <a href="#">
                    <ion-item>
                        <ion-icon class="icon" name="construct"></ion-icon>
                ...
                <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                    <li><a href="BanSearch.jsp">
                        <ion-item>
                            <ion-icon class="subIcon" name="build"></ion-icon>
                            <span class="subText">Billing Account</span>
                        </ion-item>
                    </a></li>
                    <li><a href="sidSearch.jsp">
                        <ion-item>
                            <ion-icon class="subIcon" name="build"></ion-icon>
                            <span class="subText">Service ID</span>
                        </ion-item>
                    </a></li>
                </ul>
            </li>
            <li>
                ...
                <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                    <li><a href="BCCForm.jsp">
                        <ion-item>
                            <ion-icon class="subIcon" name="today"></ion-icon>
                            <span class="subText">Refacturación</span>
                        </ion-item>
                    </a>
                    </li>
                    <li><a class="link" href="TicketsTriage.jsp">
                        <ion-item>
                            <ion-icon class="subIcon" name="pulse"></ion-icon>
                            <span class="subText">Tickets Triage</span>
                        </ion-item>
                    </a>
                    </li>
                </ul>
            ...
            <li>
                <a href="Report.jsp">
                    <ion-item>
                        <ion-icon class="icon" name="stats"></ion-icon>
            ...
            <li>
                <a href="#">
                    <ion-item>
                        ...
                        <span class="text">Billing Operations</span>
                    </ion-item>
                </a>
                <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                    <li><a href="billingOps.jsp">
                        <ion-item>
                            <ion-icon class="subIcon" name="pulse"></ion-icon>
                            <span class="subText">Open Subcases</span>
                        </ion-item>
                    </a>
                    </li>
                    <li><a href="EMA_BOT.jsp">
                        <ion-item>
                            <ion-icon class="subIcon" name="pulse"></ion-icon>
                            <span class="subText">Tickets Re-Bill</span>
                        </ion-item>
                    </a>
                    </li>
                </ul>
        ...
        <div class="container-fluid">
            <div class="row">
                <form action="" method="post" class="formulario">
                    ...
                    <input type="submit" name="SearchTkt" value="Search Ticket" class="btn btn-go"
                           onclick="this.form.action='TicketsTriage.jsp?accion=consulta'"
                           style="border: 2px solid #48D597">
                    <input type="submit" name="Refresh Page" value="Refresh Page" class="btn btn-go"
                           onclick="location.reload();" style="border: 2px solid #48D597">
                    <div class="btn-group">
                        <button id="ShowButton" type="button" class="btn btn-go dropdown-toggle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false" style="border: 2px solid #48D597">
            ...
            <div class="row text-right">
                <p id="xportxlsx" class="xport">
                    <button class="btn btn-go" type="submit" onclick="doit('xlsx');" style="border: 2px solid #48D597">
                        Download
