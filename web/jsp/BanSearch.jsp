...
<div id="wrapper" class="toggled toggled-2 full-height">
            ...
            <div class="container-fluid">
                <div class="row">
                    <form action="" method="post" class="formulario">
                        BAN:
                        <input type="text" name="txtBAN" size="20" autofocus/>
                        <input type="submit" name="Consultar" value="Consultar" class="btn btn-go"
                               onclick="this.form.action='BanSearch.jsp?accion=consulta'"
                ...
                <div id="scrollme">
                    <table id="mydatatable" data-search="true" class="table table-striped table-hover">
                        ...
                        <%
                            ...
                            if (accion.equals("consulta")) {
                                ...
                                try {
                                    ...
                                    BufferedReader reader = new BufferedReader(new FileReader("\\\\latamfs\\Latam CFS Applications\\Web Server Files\\Resources\\Query\\Web_Queries\\BanSearch.sql"));
                        ...
                        <tr>
                            ...
                            <td contenteditable="true"><%=rs.getString(2)%>
                            </td>
                            <td><%=rs.getString(3)%>
                            </td>
                            <td contenteditable="true"><%=rs.getString(4)%>
                            </td>
                            <td><%=rs.getString(5)%>
                            </td>
    ...
    <script type="text/javascript">
        $("h4").text("Billing Accounts Detail");
