      ...
      <div class="container-fluid">
        <div class="row">
          <form action="" method="post" class="formulario">
            ...
            <input type="submit" name="Consultar" value="Consultar" class="btn btn-go" onclick="this.form.action='BanSearch.jsp?accion=consulta'" style="border: 2px solid #48D597">
          </form>
        </div>
        <!---<table id="mytable">-->
        <div id="scrollme">
